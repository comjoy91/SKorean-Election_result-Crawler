...
class prop_CountCrawler_GuOld(MultiCityCrawler):
	...
	def parse_consti(self, consti, city_name=None, town_name=None):
		consti = super(prop_CountCrawler_GuOld, self).parse_consti(consti, city_name, town_name)
		return consti
...
class prop_CountCrawler_Old(MultiCityCrawler):
	...
	def parse_consti(self, consti, city_name=None, town_name=None):
		consti = super(prop_CountCrawler_Old, self).parse_consti(consti, city_name, town_name)
		return consti
...
class prop_CountCrawler_Recent(MultiCityCrawler):
	...
	def parse_consti(self, consti, city_name=None, town_name=None):
		consti = super(prop_CountCrawler_Recent, self).parse_consti(consti, city_name, town_name)
