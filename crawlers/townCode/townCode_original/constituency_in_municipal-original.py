...
class Constituency_CodeCrawler_GuOld(JSONCrawler_municipal):
	...
	def __init__(self, nth, _election_name, _election_type, _target):
		...
		self.urlParam_town_codes = dict(electionId='0000000000', electionCode=_election_name, subElectionCode =_election_type)
...
class Constituency_CodeCrawler_Recent(JSONCrawler_municipal):
	...
	def __init__(self, nth, _election_name, _election_type, _target):
		...
		self.urlParam_town_codes = dict(electionId=_election_name, electionCode=_election_type)
